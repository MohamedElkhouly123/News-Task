...
public class AdMobActivityActivity extends AppCompatActivity {
...
//                        Toast.makeText(AdMobActivityActivity.this, "onAdLoaded()", Toast.LENGTH_SHORT).show();
